  ...
  const handleSubmitForm = async (e) => {
    try {
      ...
      const data = {
        ...
        customerName,
        totalPrice:
          elderQuantity * singlePriceTable.price +
          childrentQuantity * (singlePriceTable.price / 2),
        customerEmail,
        customerAddress,
        customerNote,
        customerPhone,
          ...
          <div className="select-option-tour">
            <div className="people-number">
              ...
              <div className="people-item">
                <span>
                  Người lớn : <b>{elderQuantity}</b>
                </span>
                <div
                  onClick={() => handleDecrement("elder")}
                  className="people-btn"
                >
                  <AiOutlineMinus />
                </div>
                <div
                  onClick={() => handleIncrement("elder")}
                  className="people-btn"
                >
                  <AiOutlinePlus />
                </div>
              ...
              <div className="people-item">
                <span>
                  Trẻ em : <b>{childrentQuantity}</b>
                </span>
                <div
                  onClick={() => handleDecrement("childrent")}
                  className="people-btn"
                >
                  <AiOutlineMinus />
                </div>
                <div
                  onClick={() => handleIncrement("childrent")}
                  className="people-btn"
                >
                  <AiOutlinePlus />
                </div>
          ...
          <div className="customer-info-item">
            <form action="" onSubmit={handleSubmitForm}>
              <span style={{ color: "red" }}>
                {orderErrorMessage && orderErrorMessage[0]}
              </span>
              ...
              <div className="customer-note">
                ...
                <textarea
                  ...
                  cols="30"
                  rows="10"
                  placeholder="Viết ghi chú cho chúng tôi !"
